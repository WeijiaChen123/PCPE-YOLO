...
def get_params():
    params = {
        #'weight': 'F:/yolo_data/experiment/(3-3)YOLOv8m-PIG_CAA_P2_EUCB-Visdrone/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'weight': 'F:/yolo_data/experiment/(1-7)YOLOv8m-Visdrone-200/weights/best.pt',
        'device': 'cpu',
...
if __name__ == '__main__':
    ...
    model(r'C:/Users/Lenovo/Desktop/test_img/3.jpg', 'C:/Users/Lenovo/Desktop/Y_heatmap/map3')
